...
?>
  ...
  <div id="home" class="intro route bg-image" style="background-image: url(img/rokid_fantasy-74.gif)">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">Nos Montres Connectées, Nos Ordinateurs, Nos Batteries Externes, Nos Port USB, Nos Tablettes ,Vos Commandes Sécuriser</span><strong class="text-slider"></strong></p>
      ...
      <div class="row"> <!-- En-tête du bloc Compétences -->
        <div class="col-sm-12">
          <div class="title-box text-center">
            ...
            <p class="subtitle-a">
              <a href="datas/figma-CV-Steve-Danner.pdf" target="_blank">Télécharger Mon CurriCulum-Vitae Au Format PDF.</a>
              <br>
              <a href="img/SD74LoGo.png" target="_blank">Télécharge Mon LoGO</a>
              <br>
...
<!--/ Section Tablettes End /-->
  ...
  <div class="testimonials paralax-mf bg-image" style="background-image: url(img/exosquellette-74.gif)">
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                <img src="img/cyber-digital-74.gif" alt="" class="rounded-circle b-shadow-a">
                <span class="author">L'imformatique pour tous</span>
              </div>
            ...
            <div class="testimonial-box">
              <div class="author-test">
                <img src="img/Pc74-ph.gif" alt="" class="rounded-circle b-shadow-a">
                <span class="author">Des PC Design</span>
              </div>
              <div class="content-test">
                <p class="description lead">
                  Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Lorem ipsum dolor sit amet,
