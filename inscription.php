...
if($_POST)
{
    ...
    else
    {
        ...
        else
        {
            ...
            executeRequete("INSERT INTO membres (pseudo, mdp, nom, prenom, email, civilite, ville, code_postal, adresse) VALUES ('$_POST[pseudo]', '$_POST[mdp]', '$_POST[nom]', '$_POST[prenom]', '$_POST[email]', '$_POST[civilite]', '$_POST[ville]', '$_POST[code_postal]', '$_POST[adresse]')");
...
<form class="conect" method="post" action="">
    ...
    <input class="civil-m" name="civilite" value="m" checked="" type="radio">Homme
    <input class="civil-m"  name="civilite" value="f" type="radio">Femme<br><br>
